...
contract SimpleCustody {
    ...
    function allocate(address payable receiver,address asset, uint256 amount) public {
    ...
    function multialloc(address payable receiver,address asset, uint256 amount) public {
