    ...
    namespace solidity {
            ...
            switch (_unaryOperation.getOperator()) {
                ...
                case Token::Dec: // -- (pre- or postfix)
                    ...
                    if (!_unaryOperation.isPrefixOperation()) {
                        ...
                        solUnimplementedAssert(_unaryOperation.annotation().type->sizeOnStack() == 1,
                ...
                default:
                    solAssert(false,
                              "Invalid unary operator: " + string(Token::toString(_unaryOperation.getOperator())));
            }
            return false;
        }
        ...
        bool ExpressionCompiler::visit(BinaryOperation const &_binaryOperation) {
            ...
            if (c_op == Token::And || c_op == Token::Or) // special case: short-circuiting
                ...
                TypePointer rightTargetType = Token::isShiftOp(c_op) ? rightExpression.annotation().type->mobileType()
                                                                     : commonType;
                ...
                bool swap = m_optimize && Token::isCommutativeOp(c_op) && isLiteral(rightExpression) &&
            ...
            if (_functionCall.annotation().kind == FunctionCallKind::StructConstructorCall) {
                ...
                switch (function.kind()) {
                            ...
                            if (auto identifier = dynamic_cast<Identifier const *>(&_functionCall.expression()))
                                if (auto functionDef = dynamic_cast<FunctionDefinition const *>(identifier->annotation().referencedDeclaration)) {
                                    ...
                                    utils().pushCombinedFunctionEntryLabel(
                                            m_context.resolveVirtualFunction(*functionDef), false);
                                    shortcutTaken = true;
                                }
                    ...
                    case FunctionType::Kind::GetDelegateInfo: {
                        ...
                        if (function.kind() == FunctionType::Kind::IsDelegate) {
                            m_context << Instruction::ISDELEGATE;
                        }
                    ...
                    case FunctionType::Kind::Log4: {
                        ...
                        for (unsigned arg = logNumber; arg > 0; --arg) {
                            ...
                            utils().convertType(*arguments[arg]->annotation().type, *function.parameterTypes()[arg],
                                                true);
                        }
                        arguments.front()->accept(*this);
                        utils().fetchFreeMemoryPointer();
                    ...
                    case FunctionType::Kind::ObjectCreation: {
                        ...
                        if (arrayType.isByteArray())
                            ...
                            m_context << u256(31) << Instruction::ADD << u256(31) << Instruction::NOT
                                      << Instruction::AND;
                        else
        ...
        void ExpressionCompiler::appendShiftOperatorCode(Token::Value _operator, Type const &_valueType,
            ...
            switch (_operator) {
                ...
                case Token::SAR:
                    ...
                    if (m_context.evmVersion().hasBitwiseShifting() && !c_valueSigned)
                        ...
                        m_context << u256(2) << Instruction::EXP << Instruction::SWAP1
        ...
        void ExpressionCompiler::appendExternalFunctionCall(
            ...
            bool returnSuccessCondition =
                    funKind == FunctionType::Kind::BareCall || funKind == FunctionType::Kind::BareCallCode ||
                    funKind == FunctionType::Kind::BareDelegateCall;
            bool isCallCode = funKind == FunctionType::Kind::BareCallCode || funKind == FunctionType::Kind::CallCode;
            bool isDelegateCall =
                    funKind == FunctionType::Kind::BareDelegateCall || funKind == FunctionType::Kind::DelegateCall;
            bool useStaticCall =
            ...
            if (funKind == FunctionType::Kind::External || funKind == FunctionType::Kind::CallCode ||
            ...
            if (returnSuccessCondition) {
                ...
                if (dynamicReturnSize) {
                    solAssert(haveReturndatacopy, "");
                    m_context.appendInlineAssembly("{ returndatacopy(return_data_start, 0, returndatasize()) }",
                                                   {"return_data_start"});
                } else
                    solAssert(retSize > 0, "");
        ...
        void
        ExpressionCompiler::appendExpressionCopyToMemory(Type const &_expectedType, Expression const &_expression) {
        ...
        void
        ExpressionCompiler::setLValueFromDeclaration(Declaration const &_declaration, Expression const &_expression) {
