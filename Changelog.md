...
### 0.4.23-aoaio-v1.0 ee22c74

Features:
 * Add multi-asset support: add property ``msg.asset``, ``msg.assetvalue`` ,and functions of type `address`: ``balanceOf(address)``, ``transferAsset(address,uint256)``, ``sendAsset(address,uint256) return (bool)``.
 * support for aoa-style address, such as: AOA77ce49313a906f41f3ce1a6ba2631a31eae5d607
